...
- [#19](https://github.com/ts-api-kit/ts-api-kit/pull/19) [`9418371`](https://github.com/ts-api-kit/ts-api-kit/commit/94183718e543cd0e5ffb3bb3fe2a83573d81430e) Thanks [@devzolo](https://github.com/devzolo)! - Default OpenAPI generation mode is now `"none"` (runtime builder), not `"memory"` (AST compiler).
