...
export function isGroupSegment(seg: string) {
	return seg.startsWith("(") && seg.endsWith(")");
}
export function isParamSegment(seg: string) {
	return seg.startsWith("[") && seg.endsWith("]") && !seg.startsWith("[...");
}
export function isRestParamSegment(seg: string) {
	return seg.startsWith("[...") && seg.endsWith("]");
}
export function segmentToPath(seg: string) {
...
export function fsPathToRoutePath(absRoutesDir: string, absFileDir: string) {
